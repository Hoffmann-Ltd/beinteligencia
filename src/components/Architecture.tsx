...
function ArchDiagram() {
  ...
  return (
    <div ref={ref} className={`arch ${visible ? 'is-visible' : ''}`}>
      <div className="arch__diagram">
        <svg viewBox="0 0 1000 620" className="arch__svg" xmlns="http://www.w3.org/2000/svg" aria-label="BE Inteligência architecture diagram">
          <style>{`
            ...
            .arch__node{opacity:0;transform:translateY(10px);transition:opacity 800ms cubic-bezier(0.16,1,0.3,1),transform 800ms cubic-bezier(0.16,1,0.3,1)}
            .is-visible .arch__node{opacity:1;transform:translateY(0)}
            .is-visible .arch__node--1{transition-delay:100ms}
            .is-visible .arch__node--2{transition-delay:500ms}
            .is-visible .arch__node--3{transition-delay:900ms}
            .is-visible .arch__node--4{transition-delay:1000ms}
            .is-visible .arch__node--5{transition-delay:1100ms}
            ...
            .svg-label{letter-spacing:3px;font-family:'Montserrat',sans-serif}
          `}</style>

          <g className="arch__node arch__node--1">
          ...
          <g className="arch__node arch__node--2">
          ...
          <g className="arch__node arch__node--3">
          ...
          <g className="arch__node arch__node--4">
          ...
          <g className="arch__node arch__node--5">
      ...
      <div className="arch__data">
        <span className="arch__data__label">Data sources</span>
        <span className="arch__data__items">QuickBooks · Silverware POS · Email · OpenTable · Opera PMS · Database · CRM · Excel · TripAdvisor · Google</span>
      </div>
    </div>
  )
}
